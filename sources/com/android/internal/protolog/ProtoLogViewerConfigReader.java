...
public final class ProtoLogViewerConfigReader {
    public TreeMap mLogMessageMap = null;

    public final synchronized void loadViewerConfig(InputStream inputStream) throws IOException, JSONException {
