...
public final /* synthetic */ class AsyncSensorManager$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ AsyncSensorManager$$ExternalSyntheticLambda2(Object obj, Object obj2, Object obj3, int i) {
        this.$r8$classId = i;
        this.f$0 = obj;
        this.f$1 = obj2;
        this.f$2 = obj3;
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                for (int i = 0; i < asyncSensorManager.mPlugins.size(); i++) {
                    ((SensorManagerPlugin) asyncSensorManager.mPlugins.get(i)).unregisterListener(sensor, sensorEventListener);
                }
                return;
            default:
                ...
                notificationContentInflater.mRemoteViewCache.removeCachedView((NotificationEntry) this.f$2, 2);
                return;
        }
    }
}
