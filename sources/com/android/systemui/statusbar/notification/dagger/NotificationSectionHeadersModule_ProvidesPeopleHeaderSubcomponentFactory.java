...
public final class NotificationSectionHeadersModule_ProvidesPeopleHeaderSubcomponentFactory implements Factory<SectionHeaderControllerSubcomponent> {
    ...
    public final Object mo144get() {
        SectionHeaderControllerSubcomponent build = this.builderProvider.mo144get().mo142nodeLabel("people header").headerText(2131952920).mo141clickIntentAction("android.settings.CONVERSATION_SETTINGS").build();
