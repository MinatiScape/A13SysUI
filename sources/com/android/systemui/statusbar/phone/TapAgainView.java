...
public class TapAgainView extends TextView {
    public final void animateIn() {
        int dimensionPixelSize = ((TextView) this).mContext.getResources().getDimensionPixelSize(2131165852);
    ...
    public final void updateColor() {
        setTextColor(getResources().getColor(2131100468, ((TextView) this).mContext.getTheme()));
        setBackground(getResources().getDrawable(2131232616, ((TextView) this).mContext.getTheme()));
    }
