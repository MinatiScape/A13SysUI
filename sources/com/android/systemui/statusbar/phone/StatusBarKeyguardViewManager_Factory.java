...
public final class StatusBarKeyguardViewManager_Factory implements Factory<StatusBarKeyguardViewManager> {
    ...
    public final Object mo144get() {
        ...
        ViewMediatorCallback viewMediatorCallback = this.callbackProvider.mo144get();
        this.lockPatternUtilsProvider.mo144get();
        return new StatusBarKeyguardViewManager(viewMediatorCallback, this.sysuiStatusBarStateControllerProvider.mo144get(), this.configurationControllerProvider.mo144get(), this.keyguardUpdateMonitorProvider.mo144get(), this.dreamOverlayStateControllerProvider.mo144get(), this.navigationModeControllerProvider.mo144get(), this.dockManagerProvider.mo144get(), this.notificationShadeWindowControllerProvider.mo144get(), this.keyguardStateControllerProvider.mo144get(), this.notificationMediaManagerProvider.mo144get(), this.keyguardBouncerFactoryProvider.mo144get(), this.keyguardMessageAreaFactoryProvider.mo144get(), this.sysUIUnfoldComponentProvider.mo144get(), DoubleCheck.lazy(this.shadeControllerProvider), this.latencyTrackerProvider.mo144get());
    }
}
