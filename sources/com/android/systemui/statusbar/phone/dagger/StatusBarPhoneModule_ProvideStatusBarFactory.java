...
public final class StatusBarPhoneModule_ProvideStatusBarFactory implements Factory<StatusBar> {
    ...
    public final Object mo144get() {
        ...
        StatusBarSignalPolicy statusBarSignalPolicy = this.statusBarSignalPolicyProvider.mo144get();
        ...
        NotificationInterruptStateProvider notificationInterruptStateProvider = this.notificationInterruptStateProvider.mo144get();
        ...
        Optional<LegacySplitScreen> optional2 = this.splitScreenOptionalProvider.mo144get();
        ...
        KeyguardIndicationController keyguardIndicationController = this.keyguardIndicationControllerProvider.mo144get();
        DemoModeController demoModeController = this.demoModeControllerProvider.mo144get();
        Lazy lazy4 = DoubleCheck.lazy(this.notificationShadeDepthControllerProvider);
        ...
        LockscreenShadeTransitionController lockscreenShadeTransitionController = this.transitionControllerProvider.mo144get();
