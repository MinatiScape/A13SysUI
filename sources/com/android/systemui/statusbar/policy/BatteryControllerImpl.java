...
public class BatteryControllerImpl extends BroadcastReceiver implements BatteryController {
    ...
    public final void removeCallback(BatteryController.BatteryStateChangeCallback batteryStateChangeCallback) {
        BatteryController.BatteryStateChangeCallback batteryStateChangeCallback2 = batteryStateChangeCallback;
        synchronized (this.mChangeCallbacks) {
            this.mChangeCallbacks.remove(batteryStateChangeCallback2);
        }
    }
    ...
    public final void updatePowerSave() {
        ...
        if (isPowerSaveMode != this.mPowerSave) {
            ...
            if (DEBUG) {
                StringBuilder m = VendorAtomValue$$ExternalSyntheticOutline1.m("Power save is ");
                if (this.mPowerSave) {
                    str = "on";
                } else {
                    str = "off";
                }
                ExifInterface$$ExternalSyntheticOutline2.m(m, str, "BatteryController");
            }
            firePowerSaveChanged();
        }
    }
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (action.equals("android.intent.action.BATTERY_CHANGED")) {
            ...
            this.mMainHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.policy.BatteryControllerImpl.1
                ...
                public Intent mTestIntent = new Intent("android.intent.action.BATTERY_CHANGED");
