...
public class LaunchConversationActivity extends Activity {
    ...
    public final void clearNotificationIfPresent(String str, String str2, UserHandle userHandle) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                if (!(this.mIStatusBarService == null || (commonNotifCollection = this.mCommonNotifCollection) == null || (entry = commonNotifCollection.getEntry(str)) == null || entry.mRanking == null)) {
