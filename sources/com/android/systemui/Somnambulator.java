...
public class Somnambulator extends Activity {
    ...
    public final void onStart() {
        ...
        if ("android.intent.action.CREATE_SHORTCUT".equals(intent.getAction())) {
            ...
            intent3.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", Intent.ShortcutIconResource.fromContext(this, 2131755008));
            intent3.putExtra("android.intent.extra.shortcut.INTENT", intent2);
            intent3.putExtra("android.intent.extra.shortcut.NAME", getString(2131953311));
            setResult(-1, intent3);
