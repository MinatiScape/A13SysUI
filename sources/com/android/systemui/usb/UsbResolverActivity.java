    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (this.mForwardResolveInfo != null) {
            if (arrayList2.size() > 1) {
                ...
                intent4.setComponent(ComponentName.unflattenFromString(getResources().getString(17040036)));
        ...
        UsbResolverActivity.super.onCreate(bundle, intent2, getResources().getText(17039849), (Intent[]) null, arrayList, true);
        CheckBox checkBox = (CheckBox) findViewById(16908772);
        if (checkBox == null) {
            return;
        }
        if (this.mDevice == null) {
            checkBox.setText(2131951883);
        } else {
            checkBox.setText(2131951884);
        }
    }
}
