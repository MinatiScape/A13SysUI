...
public final class ColorInversionTile extends QSTileImpl<QSTile.BooleanState> {
    public final QSTile.Icon mIcon = QSTileImpl.ResourceIcon.get(2131232012);
    ...
    public final CharSequence getTileLabel() {
        return this.mContext.getString(2131953116);
    }
    ...
    public final void handleUpdateState(QSTile.BooleanState booleanState, Object obj) {
        ...
        booleanState2.label = this.mContext.getString(2131953116);
    ...
    /* JADX WARN: Type inference failed for: r1v3, types: [com.android.systemui.qs.tiles.ColorInversionTile$1] */
    public ColorInversionTile(QSHost qSHost, Looper looper, Handler handler, FalsingManager falsingManager, MetricsLogger metricsLogger, StatusBarStateController statusBarStateController, ActivityStarter activityStarter, QSLogger qSLogger, UserTracker userTracker, SecureSettings secureSettings) {
        ...
        this.mSetting = new SettingObserver(secureSettings, this.mHandler, userTracker.getUserId()) { // from class: com.android.systemui.qs.tiles.ColorInversionTile.1
