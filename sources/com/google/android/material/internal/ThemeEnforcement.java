...
public final class ThemeEnforcement {
    public static final int[] APPCOMPAT_CHECK_ATTRS = {2130968838};
    public static final int[] MATERIAL_CHECK_ATTRS = {2130968843};
    ...
    public static void checkCompatibleTheme(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (z) {
            ...
            if (!context.getTheme().resolveAttribute(2130969247, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
