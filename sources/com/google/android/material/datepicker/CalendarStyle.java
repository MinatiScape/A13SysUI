...
public final class CalendarStyle {
    ...
    public CalendarStyle(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, 2130969428, MaterialCalendar.class.getCanonicalName()), R$styleable.MaterialCalendar);
