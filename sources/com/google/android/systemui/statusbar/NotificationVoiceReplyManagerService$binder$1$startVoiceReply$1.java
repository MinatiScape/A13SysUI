...
@DebugMetadata(c = "com.google.android.systemui.statusbar.NotificationVoiceReplyManagerService$binder$1$startVoiceReply$1", f = "NotificationVoiceReplyManagerService.kt", l = {92}, m = "invokeSuspend")
...
final class NotificationVoiceReplyManagerService$binder$1$startVoiceReply$1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(Continuation<? super Unit> continuation) {
        return new NotificationVoiceReplyManagerService$binder$1$startVoiceReply$1(this.this$0, this.this$1, this.$sessionToken, this.$userMessageContent, continuation).invokeSuspend(Unit.INSTANCE);
    }
