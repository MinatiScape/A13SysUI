...
@DebugMetadata(c = "com.google.android.systemui.statusbar.notification.voicereplies.DebugNotificationVoiceReplyClient$startClient$job$1$receiver$1$onReceive$1", f = "NotificationVoiceReplyManager.kt", l = {1145}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class DebugNotificationVoiceReplyClient$startClient$job$1$receiver$1$onReceive$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public final /* synthetic */ VoiceReplySubscription $subscription;
    public final /* synthetic */ Ref$IntRef $token;
    public int label;

    /* compiled from: NotificationVoiceReplyManager.kt */
    /* renamed from: com.google.android.systemui.statusbar.notification.voicereplies.DebugNotificationVoiceReplyClient$startClient$job$1$receiver$1$onReceive$1$1  reason: invalid class name */
    /* loaded from: classes.dex */
    public static final class AnonymousClass1 extends Lambda implements Function0<Unit> {
        ...
        public final Unit invoke() {
            Log.d("NotifVoiceReplyDebug", "voice reply session failed");
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new DebugNotificationVoiceReplyClient$startClient$job$1$receiver$1$onReceive$1(this.$subscription, this.$token, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (voiceReplySubscription.startVoiceReply(i2, null, r4, r5, this) == coroutineSingletons) {
