...
public final class FocusStrategy {
    ...
    public static class SequentialComparator<T> implements Comparator<T> {
        ...
        public final int compare(T t, T t2) {
            ...
            Objects.requireNonNull((ExploreByTouchHelper.AnonymousClass1) this.mAdapter);
            AccessibilityNodeInfoCompat accessibilityNodeInfoCompat = (AccessibilityNodeInfoCompat) t;
            Objects.requireNonNull(accessibilityNodeInfoCompat);
            accessibilityNodeInfoCompat.mInfo.getBoundsInScreen(rect);
            Objects.requireNonNull((ExploreByTouchHelper.AnonymousClass1) this.mAdapter);
            AccessibilityNodeInfoCompat accessibilityNodeInfoCompat2 = (AccessibilityNodeInfoCompat) t2;
            Objects.requireNonNull(accessibilityNodeInfoCompat2);
            accessibilityNodeInfoCompat2.mInfo.getBoundsInScreen(rect2);
            int i = rect.top;
            int i2 = rect2.top;
            if (i < i2) {
                return -1;
        ...
        public SequentialComparator(boolean z, ExploreByTouchHelper.AnonymousClass1 r3) {
            this.mIsLayoutRtl = z;
            this.mAdapter = r3;
        }
    }
