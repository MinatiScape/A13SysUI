...
public final class RowStyle {
    ...
    public RowStyle(Context context, SliceStyle sliceStyle) {
        ...
        this.mImageSize = context.getResources().getDimensionPixelSize(2131165273);
    }
    ...
    public RowStyle(Context context, int i, SliceStyle sliceStyle) {
        ...
        try {
            ...
            this.mImageSize = (int) obtainStyledAttributes.getDimension(9, context.getResources().getDimensionPixelSize(2131165273));
