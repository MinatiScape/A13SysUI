...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public final Uri getUriForFile(File file) {
            ...
            try {
                ...
                throw new IllegalArgumentException(SupportMenuInflater$$ExternalSyntheticOutline0.m("Failed to find configured root that contains ", canonicalPath));
            } catch (IOException unused) {
    ...
    public static SimplePathStrategy parsePathStrategy(Context context, String str) throws IOException, XmlPullParserException {
        ...
        if (resolveContentProvider != null) {
            ...
            throw new IllegalArgumentException(SupportMenuInflater$$ExternalSyntheticOutline0.m("Couldn't find meta-data for provider with authority ", str));
        }
    }
    ...
    public final ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        ...
        if ("r".equals(str)) {
            ...
            throw new IllegalArgumentException(SupportMenuInflater$$ExternalSyntheticOutline0.m("Invalid mode: ", str));
        }
