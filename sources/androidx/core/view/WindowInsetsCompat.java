...
public final class WindowInsetsCompat {
    ...
    public static class Impl20 extends Impl {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl
        public WindowInsetsCompat inset(int i, int i2, int i3, int i4) {
            BuilderImpl30 builderImpl30 = new BuilderImpl30(WindowInsetsCompat.toWindowInsetsCompat(this.mPlatformInsets, null));
    ...
    public final WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        ...
        builderImpl30.setSystemWindowInsets(Insets.of(i, i2, i3, i4));
        return builderImpl30.build();
    }
