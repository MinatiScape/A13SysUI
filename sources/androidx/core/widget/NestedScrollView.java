...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public final String toString() {
            StringBuilder m = VendorAtomValue$$ExternalSyntheticOutline1.m("HorizontalScrollView.SavedState{");
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 2130969517);
    }
    ...
    public final void computeScroll() {
        if (!this.mScroller.isFinished()) {
            ...
            boolean z = false;
            iArr[1] = 0;
            this.mChildHelper.dispatchNestedPreScroll(0, i, iArr, null, 1);
    ...
    */
    ...
    public final boolean stopGlowAnimations(MotionEvent motionEvent) {
        ...
        if (EdgeEffectCompat$Api31Impl.getDistance(this.mEdgeGlowTop) != 0.0f) {
            EdgeEffectCompat$Api31Impl.onPullDistance(this.mEdgeGlowTop, 0.0f, motionEvent.getY() / getHeight());
            z = true;
        } else {
            z = false;
        }
        ...
        EdgeEffectCompat$Api31Impl.onPullDistance(this.mEdgeGlowBottom, 0.0f, 1.0f - (motionEvent.getY() / getHeight()));
        return true;
    }
    ...
    */
    ...
    public final void onNestedScrollInternal(int i, int i2, int[] iArr) {
        ...
        NestedScrollingChildHelper nestedScrollingChildHelper = this.mChildHelper;
        Objects.requireNonNull(nestedScrollingChildHelper);
        nestedScrollingChildHelper.dispatchNestedScrollInternal(0, scrollY2, 0, i - scrollY2, null, i2, iArr);
    }
