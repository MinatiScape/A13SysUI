...
public class MediaNowPlayingView extends LinearLayout {
    ...
    public MediaNowPlayingView(Context context, AttributeSet attributeSet) {
        ...
        LayoutInflater.from(context).inflate(2131624218, (ViewGroup) this, true);
        ImageView imageView = (ImageView) findViewById(2131427555);
        this.mImage1 = imageView;
        ImageView imageView2 = (ImageView) findViewById(2131427556);
        this.mImage2 = imageView2;
        ImageView imageView3 = (ImageView) findViewById(2131427557);
