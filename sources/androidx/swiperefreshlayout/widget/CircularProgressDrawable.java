...
public final class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public static void updateRingColor(float f, Ring ring) {
        if (f > 0.75f) {
            ...
            int i6 = (i2 >> 8) & 255;
            int i7 = i2 & 255;
            ring.mCurrentColor = (i7 + ((int) (f2 * ((i3 & 255) - i7)))) | ((i4 + ((int) ((((i3 >> 24) & 255) - i4) * f2))) << 24) | ((i5 + ((int) ((((i3 >> 16) & 255) - i5) * f2))) << 16) | ((i6 + ((int) ((((i3 >> 8) & 255) - i6) * f2))) << 8);
            return;
        }
        Objects.requireNonNull(ring);
    ...
    public final void applyTransformation(float f, Ring ring, boolean z) {
        ...
        if (this.mFinishing) {
            ...
            ring.mRotation = MotionController$$ExternalSyntheticOutline0.m((float) (Math.floor(ring.mStartingRotation / 0.8f) + 1.0d), f6, f, f6);
        } else if (f != 1.0f || z) {
            Objects.requireNonNull(ring);
    ...
    public CircularProgressDrawable(Context context) {
        ...
        ofFloat.addListener(new Animator.AnimatorListener() { // from class: androidx.swiperefreshlayout.widget.CircularProgressDrawable.2
            ...
            public final void onAnimationRepeat(Animator animator) {
                ...
                int length = (ring3.mColorIndex + 1) % iArr2.length;
