            ...
            if (readInt2 == 1) {
                ...
                while (readInt > 0) {
                    ...
                    if (readString == null) {
                        ...
                        try {
                            serializable = (Serializable) new ObjectInputStream(new ByteArrayInputStream(readByteArray())) { // from class: androidx.versionedparcelable.VersionedParcel.1
                            ...
                            throw new RuntimeException(AbstractResolvableFuture$$ExternalSyntheticOutline0.m("Unable to read Serializable object (name = ", readString, ")"), e);
                        } catch (ClassNotFoundException e2) {
                            throw new RuntimeException(AbstractResolvableFuture$$ExternalSyntheticOutline0.m("Unable to read Serializable object (name = ", readString, ")"), e2);
                        }
                    }
                ...
                while (i3 < length) {
                    ...
                    if (serializable == null) {
                        ...
                        try {
                            ...
                            throw new RuntimeException(AbstractResolvableFuture$$ExternalSyntheticOutline0.m("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e);
                        }
                    }
                    i3++;
                }
